...
@Component({
  ...
  styles: [`
    ...
    .nav-tab {
      padding: 0.5rem 0.5rem; border: none; background: none;
    ...
    .status-badge { padding: 0.25rem 0.5rem; border-radius: 20px; font-size: 0.72rem; font-weight: 700; letter-spacing: 0.05em; }
