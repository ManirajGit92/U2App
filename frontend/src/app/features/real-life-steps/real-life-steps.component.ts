...
import {
  RealLifeStepsService,
  GameState,
  CellConfig,
  Player,
  Token,
} from './real-life-steps.service';
...
@Component({
    ...
    <div class="game-container">
      <div class="header-section">
        ...
        <div class="header-actions" *ngIf="!(state$ | async)?.isStarted">
          <a class="btn-outline" routerLink="/real-life-steps/number-chess-battle"
            >Number Chess Battle</a
          >
          <a class="btn-outline" routerLink="/real-life-steps/custom-board-creator"
            >Custom Board Creator</a
          >
          <button class="btn-outline" (click)="downloadRules()">
            Download Board Rules (Excel)
          </button>
      ...
      <div class="glass-card setup-card" *ngIf="!(state$ | async)?.isStarted">
        ...
        <div class="players-setup">
          <div
            class="form-group"
            *ngFor="let p of setup.playerNames; let i = index; trackBy: trackByFn"
          >
        ...
        <ng-container *ngIf="state.isStarted">
          ...
          <div class="panel-column">
            ...
            <div class="glass-card winner-card" *ngIf="state.winner">
              ...
              <p>
                Congratulations to <strong>{{ state.winner }}</strong
                >!
              </p>
            </div>
            ...
            <div class="glass-card action-card" [ngClass]="{ inactive: state.winner }">
              ...
              <div class="dice-section">
                <button
                  class="dice-btn"
                  (click)="rollDice(state)"
                  [disabled]="!!state.winner || pendingRoll !== null"
                >
              ...
              <div class="token-selection" *ngIf="pendingRoll !== null">
                ...
                <div class="token-options">
                  <button
                    *ngFor="let token of state.players[state.currentPlayerIndex].tokens"
                    class="token-btn"
            ...
            <div class="glass-card players-card">
              ...
              >
                <div class="p-header">
                  <strong>{{ p.name }}</strong> <span>💰 {{ p.money }}</span>
                </div>
  ...
  styles: [
    `
      ...
      .board-column:fullscreen .board-wrapper {
        margin: 0 auto;
      }
      ...
      .anim-pulse .cell-emoji {
        animation: p 2s infinite;
      }
      .anim-bounce .cell-emoji {
        animation: b 1s infinite alternate;
      }
      .anim-shake .cell-emoji {
        animation: s 0.5s infinite alternate;
      }
      .anim-spin .cell-emoji {
        animation: sp 3s linear infinite;
      }
      .anim-zoom-in .cell-emoji {
        animation: zi 2s infinite alternate;
      }
      .anim-slide-up .cell-emoji {
        animation: su 2s infinite;
      }
...
export class RealLifeStepsComponent implements OnInit, OnDestroy {
  ...
  updatePlayerNames() {
    this.setup.playerNames = Array.from(
      { length: this.setup.playerCount },
      (_, i) => `Player ${i + 1}`,
    );
  }
