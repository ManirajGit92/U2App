...
@Component({
  ...
  styles: [`
    ...
    .emp-card {
      ...
      padding: 0.5rem; display: flex; flex-direction: column; align-items: center; text-align: center;
    ...
    .emp-team-badge { display: inline-block; background: var(--accent-surface); color: var(--accent-primary); font-size: 0.72rem; font-weight: 600; padding: 0.2rem 0.5rem; border-radius: 12px; margin: 0.4rem 0; }
    ...
    .add-card {
      background: none; border: 2px dashed var(--border-color); border-radius: 16px; padding: 0.5rem;
    ...
    .empty-state { text-align: center; padding: 0.5rem; color: var(--text-secondary); display: flex; flex-direction: column; align-items: center; gap: 0.75rem; }
    .empty-icon { font-size: 2.5rem; }

    .btn { display: inline-flex; align-items: center; gap: 0.4rem; padding: 0.5rem 0.5rem; border-radius: 8px; font-size: 0.88rem; font-weight: 600; cursor: pointer; border: 1px solid transparent; transition: all 0.15s; white-space: nowrap; }
    ...
    .modal-body { padding: 0.5rem 0.5rem; display: flex; flex-direction: column; gap: 1rem; }
